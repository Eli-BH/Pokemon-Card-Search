        ...
        <div className="card-face">
          ...
          <div className="stats">
            <div className="stats-left">
              ...
              <p>
                Base xp:
                <strong>{pokemon?.base_experience || "not yet known"}</strong>
              </p>
              <p>
            ...
            <div className="stats-right">
              ...
              <p>
                Base Special ATK: <strong>{pokemon?.stats[3].base_stat}</strong>
              </p>
              <p>
                Base Special DEF: <strong>{pokemon?.stats[4].base_stat}</strong>
              </p>
              <p>
